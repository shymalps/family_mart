...
class ProfilePage extends StatelessWidget {
                      ...
                      Column(
                        children: [
                            ...
                            child: _buildMenuSection([
                              ...
                              _MenuItemData(Icons.dashboard, 'Dashboard', () {
                                Get.to(
                                  ...
                                  transition: Transition.rightToLeft, // Optional: smooth transition
                                );
                          ...
                          AnimatedWrapper(
                            index: 3,
                            child: _buildMenuSection([
                              _MenuItemData(Icons.account_balance_wallet,
                                  'Credit', () {
                                Get.toNamed(RouteName.creditHistory);
                                  }),
                              _MenuItemData(
                                  Icons.book_rounded, 'Ledger', () {
                                    Get.toNamed(RouteName.ledger);
                              }),
                              _MenuItemData(Icons.settings_rounded, 'Settings',
                                  () {
    ...
    return Obx(() {
      return Column(
        children: [
          ...
          Text(profileController.customer.value?.name ?? 'Not Available',
              style: AppTextStyles.heading1, textAlign: TextAlign.center),
          const SizedBox(height: 4),
          Text(profileController.user.value?.email ?? 'Not Available',
      ...
      child: Obx(() {
        return Column(
          children: [
            ...
            _buildInfoRow(Icons.location_city_rounded, 'Place',
                profileController.customer.value?.place ?? 'Not Available'),
            const SizedBox(height: 12),
            _buildInfoRow(Icons.home_rounded, 'Address',
  ...
  Widget _buildMenuItem(IconData icon, String title, VoidCallback onTap,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            isDestructive ? AppColors.red.withOpacity(0.05) : AppColors.white,
        borderRadius: BorderRadius.circular(16),
  ...
  Widget _buildMenuTile(IconData icon, String title, VoidCallback onTap,
    ...
    return ListTile(
      ...
      trailing: Icon(Icons.chevron_right_rounded,
          color: AppColors.grey.withOpacity(0.6), size: 20),
      onTap: onTap,
    );
  }
